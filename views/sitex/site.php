...
{
    $this->title = 'Planet|' . $session['exchange']['abbr'] . '|'.$siteInfo['abbr'];
...
if (isset($session['user'])) { ?>
    ...
    <div style="display: flex; align-items:center; flex-wrap:wrap; justify-content: center;">
        ...
        <div class=" bg-wt  margin-5  padding-5" title="<?= $siteInfo['name']; ?>" style="height: 150px;width:200px; color:mediumvioletred;">
            <i class="fa fa-building fa-2x " style=" display:block; margin:auto;"></i>
            <hr />
            <h5 style="margin:10px;" class="text-center" ><?= $session['exchange']['abbr'].' - '.$siteInfo['abbr']; ?></h5>
            <h5 style="margin:10px;" class="text-center" ><?= $siteInfo['name']; ?></h5>
        </div>
    </div>
<?php } ?>
...
<div style="width:95%; padding:5px; margin:5px auto;">
    ...
    <button onclick="addSaloon(this)" exch-id="<?= $siteInfo['id']; ?>" exch-abbr="<?= $siteInfo['abbr']; ?>" class="btn btn-success" style="display: block; margin:auto;"><i class="fa fa-plus fa-lg"></i> New Saloon </button>
</div>
...
?>
    <div class="panel-group" id="accordion-<?= $saloon_id; ?>" style="margin:10px auto; width:98%; height:auto; ">
        <div class="panel panel-default">
            ...
            <div id="<?= 'saloon-collapse-' . $saloon_id; ?>" class="panel-collapse  in">
                <div class="panel-body" style="width: 98%; margin: 5px auto;padding:5px; height: 500px; overflow:auto;background-color:#2d6987; ">
                    <!-- saloon toolbar  -->
                    ...
                    <div class="saloon-div" style="position: relative;background-color:darkgray; margin:auto; margin-top:30px; width:<?= $saloon_width . 'px'; ?>; height:<?= $saloon_height . 'px'; ?>">
                        ...
                        ?>
                                <div class="odf-parent" id="odfId-<?= $odfId; ?>" style="width:<?= $width . "px"; ?>; transform:rotate(<?= $rotation . "deg"; ?>);position:absolute;top:<?= $top . 'px'; ?>; left:<?= $left . 'px'; ?>;">
                                    ...
                                    <a href="<?= Yii::$app->request->baseUrl . '/sitex/odf?id=' . $odfId; ?>">
